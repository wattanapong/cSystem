...
<?php echo $form->textFieldRow($modelc,'valueTh',array('class'=>'span5','maxlength'=>70,'readonly'=>$model->isNewRecord ? false:true,'value'=>isset($model->course)?$model->course->valueTh:"")); ?>

	<?php echo $form->textFieldRow($modelc,'valueEn',array('class'=>'span5','maxlength'=>70,'readonly'=>$model->isNewRecord ? false:true,'value'=>isset($model->course)?$model->course->valueTh:"")); ?>
