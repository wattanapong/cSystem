...
$this->menu=array(
		array('label'=>'เพิ่มรายวิชาใหม่','url'=>array(Yii::app()->baseUrl.'/../courseonsemester/create')),
		...
		array('label'=>'แก้ไขรายวิชานี้ สำหรับภาคการศึกษานี้', 'url'=>array('update', 'id'=>$model->id)),
	...
	'attributes'=>array(
		...
		array('name'=>'section',
				'value'=>CHtml::dropDownList('section_id','section',
						CHtml::listData(Section::model()->findAll(), 'id', 'value'),
						array(
...
<?php $form=$this->beginWidget('bootstrap.widgets.TbActiveForm',array(
	...
	<?php echo $form->dropDownListRow($model,'section',CHtml::listData(Section::model()->findAll(), 'id', 'value')
